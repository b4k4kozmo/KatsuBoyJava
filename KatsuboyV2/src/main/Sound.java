...
public class Sound {
	...
	public Sound() {
		...
		soundURL[0] = getClass().getResource("/sound/KatsuBoySong.wav");
		soundURL[1] = getClass().getResource("/sound/coin.wav");
		soundURL[2] = getClass().getResource("/sound/powerup.wav");
		soundURL[3] = getClass().getResource("/sound/unlock.wav");
		soundURL[4] = getClass().getResource("/sound/fanfare.wav");
		soundURL[5] = getClass().getResource("/sound/nightbeat.wav");
		...
		soundURL[17] = getClass().getResource("/sound/text.wav");
		soundURL[18] = getClass().getResource("/sound/text2.wav");
		soundURL[19] = getClass().getResource("/sound/text3.wav");
		soundURL[20] = getClass().getResource("/sound/text4.wav");
	}
