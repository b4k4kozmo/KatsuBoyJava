...
public class SaveLoad {
	...
	public void save() {
		...
		try {
			...
			ds.hasBoots = gp.player.hasBoots;
		...
		System.out.println("hmmmmm what is wrong");
	}
	public void load() {
		...
		try {
			...
			gp.player.mana = ds.maxMana;
			gp.player.strength = ds.strength;
			gp.player.dexterity = ds.dexterity;
			gp.player.exp = ds.exp;
			gp.player.nextLevelExp = ds.nextLevelExp;
			gp.player.coin = ds.coin;
			gp.player.hasBoots = ds.hasBoots;
			...
			for(int mapNum = 0; mapNum < gp.maxMap; mapNum++) {
				...
				for(int i = 0; i < gp.obj[1].length; i++) {
					...
					if(ds.mapObjectNames[mapNum][i].equals("NA") || ds.mapObjectNames[mapNum][i].equals(null)) {
